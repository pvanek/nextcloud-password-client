...
class PreferencesDialog(QDialog):
    def __init__(self, instances, *args):
        ...
        self.ui.instancesListWidget.currentRowChanged.connect(self.currentInstanceChanged)
    ...
    def testInstance(self):
        ...
        try:
            net.getFolders()
            QMessageBox.information(self, 'Network result', 'Ping to ' + name + ' is OK')
        except Exception as err:
            QMessageBox.warning(self, 'Network result', 'Error: ' + format(err))
